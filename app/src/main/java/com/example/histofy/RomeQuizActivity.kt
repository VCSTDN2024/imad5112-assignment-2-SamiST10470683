...
class RomeQuizActivity : AppCompatActivity() {
    // Array of quiz questions.
    private val questions = arrayOf(
        "1. The Ancient Romans built roads that are still used today.",
        "2. The Ancient Romans invented concrete.",
        "3. Latin was the official language of the Ancient Romans.",
        "4. Julius Caesar was a Roman emperor.",
        "5. The Roman Empire was smaller than the Greek Empire."
    )
